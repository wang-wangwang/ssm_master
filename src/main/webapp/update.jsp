			...
			<div class="form-group">
				...
				<div class="col-sm-4">	
					...
					<input type="date" class="form-control" id="birthday"
						name="birthday" value="<fmt:formatDate value="${m.birthday }" pattern="yyyy-MM-dd" />">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="date" class="form-control" id="entryday"
						name="entryday" value="<fmt:formatDate value="${m.entryday }" pattern="yyyy-MM-dd" />">
				</div>
			</div>
